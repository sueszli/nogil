...
docker compose exec main gcc -fopenmp -o ./src/3_ctypes/test_sha1 ./src/3_ctypes/test_sha1.c ./src/3_ctypes/sha1.c
docker compose exec main ./src/3_ctypes/test_sha1
rm -rf ./src/3_ctypes/test_sha1
*/
