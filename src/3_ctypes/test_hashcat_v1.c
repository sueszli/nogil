/*
docker compose exec main gcc -fopenmp -o ./src/3_ctypes/test_hashcat_v1 ./src/3_ctypes/test_hashcat_v1.c -lcrypto -lssl
docker compose exec main ./src/3_ctypes/test_hashcat_v1 aaa
rm -rf ./src/3_ctypes/test_hashcat_v1
*/
