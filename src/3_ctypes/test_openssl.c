...
docker compose exec main gcc -fopenmp -o ./src/3_ctypes/test_openssl ./src/3_ctypes/test_openssl.c -lcrypto -lssl
docker compose exec main ./src/3_ctypes/test_openssl
